...
export default function Page() {
  ...
  const baseTotal = 44.9; // 34.90 + 10 dostava
  const total = useMemo(() => (giftPack ? baseTotal + 5 : baseTotal), [giftPack]);

  const benefits = [
    { icon: "🔨", text: "Udarna funkcija – buši beton, ciglu i kamen, ne samo drvo i metal" },
    { icon: "🔋", text: "2 baterije u kompletu – dok jedna radi, druga se puni, nema stajanja" },
    { icon: "🔩", text: "Nastavci uključeni – bitovi i burgije spremni za rad odmah iz kutije" },
    { icon: "⚡", text: "Brzi punjač – baterija puna za kratko vrijeme" },
    { icon: "💼", text: "Tvrdi kofer – bušilica, baterije i nastavci uvijek na jednom mjestu" },
    { icon: "🛡️", text: "3 godine garancije – DeWalt standard profesionalnog kvaliteta" },
  ];

  const useCases = [
    { icon: "🏠", title: "Kućni majstori", desc: "Police, slike, karniše – sve sam" },
    { icon: "🧱", title: "Beton i cigla", desc: "Udarna funkcija probija sve" },
    { icon: "🪵", title: "Drvo i metal", desc: "Precizno bušenje i šarafljenje" },
    { icon: "🔧", title: "Radionica", desc: "Pouzdan alat za svaki dan" },
  ];

  const testimonials = [
    { text: "Bušio sam beton za karniše bez ikakvog problema. Udarna funkcija stvarno radi. Za ove pare - fenomenalno.", author: "Emir K.", city: "Sarajevo" },
    { text: "Dvije baterije su ključna stvar. Nikad ne čekam punjenje. Nastavci u koferu su solidni.", author: "Dragan M.", city: "Banja Luka" },
    { text: "DeWalt je DeWalt. Šarafim, bušim, sve radi kako treba. Kofer drži sve na okupu.", author: "Nikola P.", city: "Tuzla" },
    { text: "Kupio sam je za kućne popravke. Žena me sad zove majstorom. Preporučujem svakome.", author: "Adis H.", city: "Mostar" },
    { text: "Garancija 3 godine je ono što me kupilo. Alat radi odlično već mjesecima.", author: "Zoran S.", city: "Zenica" },
    { text: "Poklonio bratu za useljenje u stan. Kaže da je ne ispušta iz ruku. Odličan poklon.", author: "Damir B.", city: "Bihać" },
  ];

  const faqs = [
    { q: "Šta je sve u setu?", a: "Aku udarna bušilica, 2 baterije, brzi punjač, set nastavaka (bitovi i burgije) i tvrdi kofer." },
    { q: "Može li bušiti beton?", a: "Da. Bušilica ima udarnu funkciju koja omogućava bušenje betona, cigle i kamena — ne samo drveta i metala." },
    ...
    { q: "Kakva je garancija?", a: "Na bušilicu dolazi 3 godine garancije – DeWalt profesionalni standard." },
    { q: "Kakvi nastavci dolaze?", a: "U koferu dolazi set bitova za šarafljenje i burgija za bušenje – spreman si za rad odmah." },
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const order = {
      product_name:  "DeWalt aku udarna bušilica sa nastavcima",
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar { background: #111; color: #FFC40C; text-align: center; padding: 10px 16px; font-size: 13px; font-weight: 800; }
        .brand-banner { background: #FFC40C; padding: 16px; display: flex; align-items: center; justify-content: space-between; gap: 12px; }
        .brand-name { font-size: 24px; font-weight: 900; color: #111; letter-spacing: .06em; text-transform: uppercase; }
        .brand-sub { font-size: 12px; font-weight: 700; color: rgba(0,0,0,0.5); margin-top: 2px; }
        .brand-badge { background: #111; color: #FFC40C; font-size: 12px; font-weight: 900; padding: 6px 14px; border-radius: 8px; white-space: nowrap; }
        .hero { background: #fff; padding: 20px 16px 24px; border-bottom: 3px solid #f0f0f0; }
        .hero-badge { display: inline-block; background: #fffbeb; color: #92400e; font-size: 12px; font-weight: 800; padding: 5px 12px; border-radius: 6px; border: 1px solid #fde68a; margin-bottom: 12px; }
        ...
        .hero-img { width: 100%; border-radius: 14px; overflow: hidden; border: 3px solid #FFC40C; position: relative; margin-bottom: 16px; background: #fffbeb; }
        .hero-img img { width: 100%; display: block; }
        .hero-img-badge { position: absolute; top: 12px; left: 12px; background: #111; color: #FFC40C; font-size: 13px; font-weight: 900; padding: 5px 12px; border-radius: 8px; }
        ...
        .kit-box { background: #fffbeb; border: 2px solid #fde68a; border-radius: 14px; padding: 14px; margin-bottom: 16px; }
        .kit-title { font-size: 12px; font-weight: 900; color: #92400e; text-transform: uppercase; letter-spacing: .05em; margin-bottom: 10px; }
        ...
        .kit-dot { width: 7px; height: 7px; border-radius: 50%; background: #F5A800; flex-shrink: 0; }
        ...
        .price-tag { background: #fffbeb; color: #92400e; font-size: 12px; font-weight: 800; padding: 4px 10px; border-radius: 6px; border: 1px solid #fde68a; }
        .cta-btn { width: 100%; padding: 18px; background: #FFC40C; color: #111; font-family: 'Nunito', sans-serif; font-size: 18px; font-weight: 900; border: none; border-radius: 12px; cursor: pointer; transition: background .15s, transform .15s; box-shadow: 0 4px 14px rgba(255,196,12,0.4); }
        ...
        .warranty-banner { background: #111; border-top: 4px solid #FFC40C; padding: 18px 20px; display: flex; align-items: center; gap: 16px; margin-top: 8px; }
        .warranty-num { font-size: 48px; font-weight: 900; color: #FFC40C; line-height: 1; flex-shrink: 0; }
        ...
        .use-card { background: #fffbeb; border: 1px solid #fde68a; border-radius: 12px; padding: 14px; text-align: center; }
        ...
        .t-card { background: #f9fafb; border: 1px solid #e5e7eb; border-left: 3px solid #FFC40C; border-radius: 10px; padding: 14px; }
        ...
        .faq-icon { width: 24px; height: 24px; border-radius: 50%; background: #fffbeb; border: 1px solid #fde68a; display: flex; align-items: center; justify-content: center; font-size: 16px; font-weight: 700; color: #92400e; flex-shrink: 0; transition: transform .2s; }
        ...
        .form-section { background: #fff; margin-top: 8px; padding: 24px 16px 32px; border-top: 4px solid #FFC40C; }
        .form-header { text-align: center; margin-bottom: 20px; }
        .form-header-badge { display: inline-block; background: #111; color: #FFC40C; font-size: 12px; font-weight: 800; padding: 5px 14px; border-radius: 6px; margin-bottom: 10px; }
        ...
        .submit-btn { width: 100%; padding: 18px; background: #FFC40C; color: #111; font-family: 'Nunito', sans-serif; font-size: 20px; font-weight: 900; border: none; border-radius: 12px; cursor: pointer; transition: background .15s, transform .15s; box-shadow: 0 4px 16px rgba(255,196,12,0.35); }
      ...
      <div className="page">
        ...
        <div className="topbar">
          ⚡ DeWalt aku udarna bušilica · 2 baterije + nastavci · 3 god. garancija
        </div>
        ...
        <section className="hero">
          <div className="hero-badge">🔨 Udarna funkcija · Buši i beton</div>
          <h1>DeWalt aku udarna bušilica</h1>
          <p className="hero-sub">
            Kompletna udarna bušilica s nastavcima, dvije baterije i brzim punjačem u tvrdom koferu — buši beton, ciglu, drvo i metal.
          </p>

          <div className="hero-img">
            <span className="hero-img-badge">DEWALT</span>
            <span className="hero-img-price">34,90 KM</span>
            <img src="https://i.imgur.com/1OiJ3rN.jpeg" alt="DeWalt aku udarna bušilica sa nastavcima" />
          </div>

          <div className="kit-box">
            <div className="kit-title">✅ Kompletan set uključuje:</div>
            <div className="kit-grid">
              <div className="kit-item"><div className="kit-dot" />Aku udarna bušilica</div>
              <div className="kit-item"><div className="kit-dot" />2× baterija</div>
              <div className="kit-item"><div className="kit-dot" />Brzi punjač</div>
              <div className="kit-item"><div className="kit-dot" />Set nastavaka</div>
        ...
        <div className="warranty-banner">
          ...
          <div>
            ...
            <div className="warranty-sub">DeWalt profesionalni standard — kupuješ bez rizika</div>
          </div>
        </div>
        ...
        <section className="section">
          <div className="section-title">✅ Zašto ova bušilica</div>
        ...
        <div className="urgency">
          ...
          <div className="urgency-sub">34,90 KM za kompletan set s garancijom. Naruči danas.</div>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div className="summary-box">
                  <div className="summary-row"><span>DeWalt udarna bušilica (set)</span><span>34,90 KM</span></div>
