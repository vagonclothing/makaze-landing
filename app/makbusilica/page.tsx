...
export default function Page() {
  ...
  const testimonials = [
    ...
    { text: "Makita je Makita. Šarafim, bušim, sve radi kako treba. Kofer drži sve na okupu.", author: "Nikola P.", city: "Tuzla" },
  ...
  const faqs = [
    ...
    { q: "Kakva je garancija?", a: "Na bušilicu dolazi 3 godine garancije – Makita profesionalni standard." },
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const order = {
      product_name:  "Makita aku udarna bušilica sa nastavcima",
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="topbar">
          ⚡ Makita aku udarna bušilica · 2 baterije + nastavci · 3 god. garancija
        </div>
        ...
        <section className="hero">
          ...
          <h1>Makita aku udarna bušilica</h1>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div className="summary-box">
                  <div className="summary-row"><span>Makita udarna bušilica (set)</span><span>34,90 KM</span></div>
