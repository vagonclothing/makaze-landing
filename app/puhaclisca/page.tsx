...
export default function Page() {
  ...
  const benefits = [
    { icon: "💨", text: "Snažan mlaz zraka – lišće, prašina i nečistoća nestaju za sekunde" },
    { icon: "🔋", text: "2 baterije 15.0Ah 128V – dok jedna radi, druga se puni, nema stajanja" },
    { icon: "🔌", text: "Bez kablova – ubaciš bateriju i odmah radiš, nema razvlačenja produžnih" },
    { icon: "⚡", text: "Brzi punjač – baterija puna za kratko vrijeme, uvijek spreman" },
    { icon: "🪶", text: "Lagan i jednostavan – radi jednom rukom, bez umaranja" },
    { icon: "🛡️", text: "3 godine garancije – Makita standard profesionalnog kvaliteta" },
  ];

  const useCases = [
    { icon: "🍂", title: "Suho i mokro lišće", desc: "Očisti dvorište za par minuta" },
    { icon: "🌱", title: "Trava nakon košenja", desc: "Otpuhni pokošenu travu s staze" },
    { icon: "🏚️", title: "Radionica i garaža", desc: "Prašina i nečistoća bez metle" },
    { icon: "❄️", title: "Lagani snijeg", desc: "Očisti prilaz i stepenice" },
  ];

  const testimonials = [
    { text: "Očistio sam cijelo dvorište od lišća za 10 minuta. Prije mi je trebalo sat vremena s metlom. Fenomenalno.", author: "Emir K.", city: "Sarajevo" },
    { text: "Dvije baterije su prava stvar. Dok jednom radim, druga se puni. Nikad ne stajem usred posla.", author: "Dragan M.", city: "Banja Luka" },
    { text: "Koristim ga i za garažu i radionicu — otpuše svu prašinu i piljevinu. Makita kvalitet kao uvijek.", author: "Nikola P.", city: "Tuzla" },
    { text: "Bez kabla je ogromna razlika. Ubacim bateriju i idem gdje god treba. Lagan je, ruka se ne umara.", author: "Adis H.", city: "Mostar" },
    { text: "Iznenadio sam se koliko je snažan. Čak i mokro lišće otpuše bez problema. Vrijedi svake marke.", author: "Zoran S.", city: "Zenica" },
    { text: "Poklonio sam ocu za dvorište. Kaže da mu je najkorisniji alat. Koristi ga svaki dan u jesen.", author: "Damir B.", city: "Bihać" },
  ];

  const faqs = [
    { q: "Šta je sve u kompletu?", a: "Aku puhač lišća, 2 baterije 15.0Ah 128V, brzi punjač — komplet spreman za korištenje odmah iz kutije." },
    { q: "Može li otpuhati mokro lišće?", a: "Da. Snažan mlaz zraka nosi i suho i mokro lišće, travu nakon košenja, prašinu i sitne nečistoće." },
    { q: "Koliko traju baterije?", a: "Sa 2 baterije 15.0Ah u kompletu uvijek imaš napunjenu rezervu. Dok jednom radiš, druga se puni." },
    { q: "Treba li kabl ili benzin?", a: "Ne. Puhač radi na bateriju — nema kablova, nema benzina, nema paljenja. Ubaciš bateriju i radiš." },
    { q: "Da li je težak za rukovanje?", a: "Ne. Puhač je lagan i kompaktan, koristi se jednom rukom bez zamaranja." },
    { q: "Kakva je garancija?", a: "Na puhač dolazi 3 godine garancije – Makita profesionalni standard." },
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const order = {
      product_name:  "Makita aku puhač lišća",
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="topbar">
          💨 Makita aku puhač lišća · 2 baterije 128V · 3 god. garancija · Pouzeće
        </div>
        ...
        <section className="hero">
          <div className="hero-badge">💨 Bez kablova · Ubaci bateriju i radi</div>
          <h1>Makita aku puhač lišća</h1>
          <p className="hero-sub">
            Brzo i jednostavno očisti dvorište, terasu, prilaz, garažu ili radionicu. Bez razvlačenja kablova — ubaciš bateriju i spreman si za rad!
          </p>

          <div className="hero-img">
            <span className="hero-img-badge">MAKITA</span>
            <span className="hero-img-price">89,90 KM</span>
            <img src="https://i.imgur.com/1JHqkn7.png" alt="Makita aku puhač lišća sa dvije baterije" />
          </div>

          <div className="kit-box">
            <div className="kit-title">✅ U kompletu dobijate:</div>
            <div className="kit-grid">
              <div className="kit-item"><div className="kit-dot" />Aku puhač lišća</div>
              <div className="kit-item"><div className="kit-dot" />2× baterija 15.0Ah 128V</div>
              <div className="kit-item"><div className="kit-dot" />Brzi punjač</div>
              <div className="kit-item"><div className="kit-dot" />Spreman za rad</div>
            </div>
          </div>
        ...
        <section className="section">
          <div className="section-title">💨 Odličan za</div>
        ...
        <section className="section">
          <div className="section-title">✅ Zašto ovaj puhač</div>
        ...
        <div className="urgency">
          ...
          <div className="urgency-sub">89,90 KM za kompletan set s garancijom. Naruči danas.</div>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div className="summary-box">
                  <div className="summary-row"><span>Makita aku puhač lišća (set)</span><span>89,90 KM</span></div>
