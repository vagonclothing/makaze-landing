...
function PageContent() {
  ...
  const baseTotal = 119.9; // 109.90 + 10 dostava
  const total = useMemo(() => (giftPack ? baseTotal + 5 : baseTotal), [giftPack]);

  const benefits = [
    { icon: "🔩", text: "Aku udarni odvijač – snažno zavrće i odvrće i najtvrđe vijke bez muke" },
    { icon: "⚙️", text: "Aku brusilica – reže i brusi metal, pločice, cijevi i profile" },
    { icon: "🪛", text: "Aku bušilica – buši drvo, metal i zid, šarafi i odšarafljuje" },
    { icon: "🔋", text: "2 baterije 128V u kompletu – dok jedna radi, druga se puni, nema stajanja" },
    { icon: "⚡", text: "Brzi punjač – baterija puna za kratko vrijeme, uvijek spreman" },
    { icon: "💼", text: "Tvrdi kofer – oba alata, baterije i punjač uvijek na jednom mjestu" },
    { icon: "🛡️", text: "3 godine garancije – Makita standard profesionalnog kvaliteta" },
  ];

  const useCases = [
    { icon: "🔩", title: "Odvijač", desc: "Vijci, šarafi, montaža namještaja" },
    { icon: "⚙️", title: "Brusilica", desc: "Rezanje i brušenje metala" },
    { icon: "🪛", title: "Bušilica", desc: "Bušenje drveta, metala i zida" },
    { icon: "🔨", title: "Radionica", desc: "Tri profesionalna alata odjednom" },
  ];

  const testimonials = [
    { text: "Tri alata u jednom setu, i to Makita. Odvijač, brusilica i bušilica — sve što treba za kuću. Nevjerovatno za ovu cijenu.", author: "Emir K.", city: "Sarajevo" },
    { text: "Koristim odvijač za montažu, bušilicu za zid, brusilicu za cijevi. Sve u jednom koferu. Preporučujem.", author: "Dragan M.", city: "Banja Luka" },
    { text: "Makita nikad ne razočara. Oba alata rade odlično, dvije baterije su spas kod većih poslova.", author: "Nikola P.", city: "Tuzla" },
    { text: "Kupio sam za kuću i radionicu. Sva tri alata rade odlično, bušilica probija i beton. Sjajan set.", author: "Adis H.", city: "Mostar" },
    { text: "Garancija 3 godine i dva alata u koferu — nisam mogao odoljeti. Ne kajem se ni sekunde.", author: "Zoran S.", city: "Zenica" },
    { text: "Poklonio bratu za rođendan. Kaže da su mu oba alata stalno u upotrebi. Odličan poklon.", author: "Damir B.", city: "Bihać" },
  ];

  const faqs = [
    { q: "Šta je sve u setu?", a: "Aku udarni odvijač, aku brusilica, aku bušilica, 2 baterije 128V, brzi punjač i tvrdi kofer za transport." },
    { q: "Za šta služi udarni odvijač?", a: "Za snažno zavrtanje i odvrtanje vijaka, šarafa i matica — čak i onih najtvrđih koje obični odvijač ne može savladati." },
    { q: "Šta može brusilica?", a: "Brusilica reže i brusi metal, pločice, cijevi, profile i još mnogo toga. Nezamjenjiva za radionicu i kućne radove." },
    { q: "Šta može bušilica?", a: "Bušilica buši drvo, metal i zid, a služi i za šarafljenje. Sa tri alata pokrivaš gotovo sve kućne i radioničke poslove." },
    { q: "Koliko traju baterije?", a: "Sa 2 baterije 128V u kompletu uvijek imaš napunjenu rezervu. Brzi punjač vraća kapacitet za kratko vrijeme." },
    { q: "Kakva je garancija?", a: "Na cijeli set dolazi 3 godine garancije – Makita profesionalni standard." },
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const order = {
      product_name:  "Makita 3u1 aku odvijač, brusilica i bušilica",
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar { background: #111; color: #00A0DC; text-align: center; padding: 10px 16px; font-size: 13px; font-weight: 800; }
        .brand-banner { background: #00A0DC; padding: 16px; display: flex; align-items: center; justify-content: space-between; gap: 12px; }
        .brand-name { font-size: 24px; font-weight: 900; color: #fff; letter-spacing: .06em; text-transform: uppercase; }
        .brand-sub { font-size: 12px; font-weight: 700; color: rgba(255,255,255,0.7); margin-top: 2px; }
        .brand-badge { background: #111; color: #00A0DC; font-size: 12px; font-weight: 900; padding: 6px 14px; border-radius: 8px; white-space: nowrap; }
        .hero { background: #fff; padding: 20px 16px 24px; border-bottom: 3px solid #f0f0f0; }
        .hero-badge { display: inline-block; background: #eff9ff; color: #0369a1; font-size: 12px; font-weight: 800; padding: 5px 12px; border-radius: 6px; border: 1px solid #bae6fd; margin-bottom: 12px; }
        ...
        .hero-img { width: 100%; border-radius: 14px; overflow: hidden; border: 3px solid #00A0DC; position: relative; margin-bottom: 16px; background: #eff9ff; }
        .hero-img img { width: 100%; display: block; }
        .hero-img-badge { position: absolute; top: 12px; left: 12px; background: #111; color: #00A0DC; font-size: 13px; font-weight: 900; padding: 5px 12px; border-radius: 8px; }
        ...
        .combo-banner { background: #111; border-radius: 12px; padding: 14px; display: flex; align-items: center; justify-content: center; gap: 14px; margin-bottom: 16px; }
        .combo-item { text-align: center; }
        .combo-icon { font-size: 30px; }
        .combo-label { font-size: 11px; font-weight: 800; color: #00A0DC; margin-top: 4px; text-transform: uppercase; }
        .combo-plus { font-size: 24px; font-weight: 900; color: #fff; }
        .kit-box { background: #eff9ff; border: 2px solid #bae6fd; border-radius: 14px; padding: 14px; margin-bottom: 16px; }
        .kit-title { font-size: 12px; font-weight: 900; color: #0369a1; text-transform: uppercase; letter-spacing: .05em; margin-bottom: 10px; }
        ...
        .kit-dot { width: 7px; height: 7px; border-radius: 50%; background: #00A0DC; flex-shrink: 0; }
        ...
        .price-tag { background: #eff9ff; color: #0369a1; font-size: 12px; font-weight: 800; padding: 4px 10px; border-radius: 6px; border: 1px solid #bae6fd; }
        ...
        .warranty-banner { background: #111; border-top: 4px solid #00A0DC; padding: 18px 20px; display: flex; align-items: center; gap: 16px; margin-top: 8px; }
        .warranty-num { font-size: 48px; font-weight: 900; color: #00A0DC; line-height: 1; flex-shrink: 0; }
        ...
        .use-card { background: #eff9ff; border: 1px solid #bae6fd; border-radius: 12px; padding: 14px; text-align: center; }
        ...
        .t-card { background: #f9fafb; border: 1px solid #e5e7eb; border-left: 3px solid #00A0DC; border-radius: 10px; padding: 14px; }
        .t-stars { color: #f59e0b; font-size: 13px; margin-bottom: 6px; }
        .t-text { font-size: 13px; color: #333; line-height: 1.65; }
        .t-author { font-size: 12px; font-weight: 800; color: #0369a1; margin-top: 8px; }
        ...
        .faq-icon { width: 24px; height: 24px; border-radius: 50%; background: #eff9ff; border: 1px solid #bae6fd; display: flex; align-items: center; justify-content: center; font-size: 16px; font-weight: 700; color: #0369a1; flex-shrink: 0; transition: transform .2s; }
        ...
        .faq-item.open .faq-a { max-height: 220px; padding: 0 16px 15px; }
        .form-section { background: #fff; margin-top: 8px; padding: 24px 16px 32px; border-top: 4px solid #00A0DC; }
        .form-header { text-align: center; margin-bottom: 20px; }
        .form-header-badge { display: inline-block; background: #111; color: #00A0DC; font-size: 12px; font-weight: 800; padding: 5px 14px; border-radius: 6px; margin-bottom: 10px; }
        ...
        .inp:focus { border-color: #00A0DC; background: #fff; }
        ...
        .gift-label.checked { border-color: #00A0DC; background: #eff9ff; }
        .gift-label input { accent-color: #00A0DC; width: 18px; height: 18px; margin-top: 1px; flex-shrink: 0; }
      ...
      <div className="page">
        ...
        <div className="topbar">
          ⚡ Makita 3u1 · Odvijač + Brusilica + Bušilica · 2 baterije 128V · 3 god. garancija
        </div>

        <div className="brand-banner">
          <div>
            <div className="brand-name">⚡ Makita</div>
        ...
        <section className="hero">
          <div className="hero-badge">🔩 3u1 · Odvijač + Brusilica + Bušilica</div>
          <h1>Makita 3u1 aku set</h1>
          <p className="hero-sub">
            Tri profesionalna Makita alata u jednom kompletu — aku udarni odvijač, aku brusilica i aku bušilica, sa dvije baterije 128V, punjačem i tvrdim koferom.
          </p>

          <div className="hero-img">
            <span className="hero-img-badge">3u1 SET</span>
            <span className="hero-img-price">109,90 KM</span>
            <img src="https://i.imgur.com/EmOkWUu.png" alt="Makita 3u1 aku odvijač, brusilica i bušilica" />
          </div>
          ...
          <div className="combo-banner">
            <div className="combo-item">
              ...
              <div className="combo-label">Odvijač</div>
            </div>
            <div className="combo-plus">+</div>
            <div className="combo-item">
              <div className="combo-icon">⚙️</div>
              <div className="combo-label">Brusilica</div>
            </div>
            <div className="combo-plus">+</div>
            <div className="combo-item">
              <div className="combo-icon">🪛</div>
              <div className="combo-label">Bušilica</div>
            </div>
          </div>
          ...
          <div className="kit-box">
            ...
            <div className="kit-grid">
              <div className="kit-item"><div className="kit-dot" />Aku udarni odvijač</div>
              <div className="kit-item"><div className="kit-dot" />Aku brusilica</div>
              <div className="kit-item"><div className="kit-dot" />Aku bušilica</div>
              <div className="kit-item"><div className="kit-dot" />2× baterija 128V</div>
          ...
          <div className="price-row">
            <span className="price-new">109,90 KM</span>
        ...
        <div className="warranty-banner">
          ...
          <div>
            ...
            <div className="warranty-sub">Makita profesionalni standard — kupuješ bez rizika</div>
          </div>
        </div>

        <section className="section">
          <div className="section-title">🔨 Za šta služi</div>
        ...
        <section className="section">
          <div className="section-title">✅ Zašto ovaj set</div>
        ...
        <div className="urgency">
          ...
          <div className="urgency-sub">109,90 KM za sva tri alata s garancijom. Naruči danas.</div>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div className="summary-box">
                  <div className="summary-row"><span>Makita 3u1 set (odvijač + brusilica + bušilica)</span><span>109,90 KM</span></div>
                  <div className="summary-row"><span>Dostava</span><span>10,00 KM</span></div>
                  {giftPack && (
                    <div className="summary-row" style={{ color: "#0369a1", fontWeight: 700 }}>
