...
export default function Page() {
  ...
  const baseTotal = 99.9; // 89.90 + 10 dostava
  ...
  const useCases = [
    ...
    { icon: "🏠", title: "Kućni majstori", desc: "Sve popravke u jednom setu" },
    { icon: "🔨", title: "Radionica", desc: "Dva profesionalna alata odjednom" },
  ];

  const testimonials = [
    { text: "Dva alata u jednom setu, i to Makita. Odvijač je jak, brusilica reže sve. Za ovu cijenu nevjerovatno.", author: "Emir K.", city: "Sarajevo" },
    { text: "Koristim odvijač za montažu, brusilicu za rezanje cijevi. Baterije jake, kofer solidan. Preporučujem.", author: "Dragan M.", city: "Banja Luka" },
    { text: "Makita nikad ne razočara. Oba alata rade odlično, dvije baterije su spas kod većih poslova.", author: "Nikola P.", city: "Tuzla" },
    { text: "Kupio sam za kuću i radionicu. Odvijač skida i najtvrđe vijke, brusilica je moćna. Sjajan set.", author: "Adis H.", city: "Mostar" },
  ...
  const faqs = [
    { q: "Šta je sve u setu?", a: "Aku udarni odvijač, aku brusilica, 2 baterije 128V, brzi punjač i tvrdi kofer za transport." },
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const order = {
      product_name:  "Makita 2u1 aku udarni odvijač i brusilica",
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="topbar">
          ⚡ Makita 2u1 · Odvijač + Brusilica · 2 baterije 128V · 3 god. garancija
        </div>
        ...
        <section className="hero">
          <div className="hero-badge">🔩 2u1 · Udarni odvijač + Brusilica</div>
          <h1>Makita 2u1 aku set</h1>
          <p className="hero-sub">
            Dva profesionalna Makita alata u jednom kompletu — aku udarni odvijač i aku brusilica, sa dvije baterije 128V, punjačem i tvrdim koferom.
          </p>

          <div className="hero-img">
            <span className="hero-img-badge">2u1 SET</span>
            <span className="hero-img-price">89,90 KM</span>
            <img src="https://i.imgur.com/hQYhhSK.png" alt="Makita 2u1 aku udarni odvijač i brusilica" />
          </div>
          ...
          <div className="price-row">
            <span className="price-new">89,90 KM</span>
        ...
        <div className="urgency">
          ...
          <div className="urgency-sub">89,90 KM za oba alata s garancijom. Naruči danas.</div>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div className="summary-box">
                  <div className="summary-row"><span>Makita 2u1 set (odvijač + brusilica)</span><span>89,90 KM</span></div>
